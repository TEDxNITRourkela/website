...
import leftCenter from '../assets/img/inductions/leftCenter.svg';
import rightCenter from '../assets/img/inductions/rightCenter.svg';
import leftTriangle from '../assets/img/inductions/leftTriangle.svg';
import rightTriangle from '../assets/img/inductions/rightTriangle.svg';
      ...
      <div className={classes.container}>
        ...
        <div className={classes.content}>
          ...
          <h3 className={classes.text}>
            ...
            and there will be no late submissions.
            <br />
            If you have any queries whatsoever feel free to mail at:{' '}
            <a
