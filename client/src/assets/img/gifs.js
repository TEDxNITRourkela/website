/* eslint-disable */
export const GIFS = Object.freeze({
  SCROLL_DOWN:
    'https://res.cloudinary.com/tedxnitrourkela/image/upload/assets/gif/scrollDown_imh1hj.gif',
  PEAK:
...
export const VIDEOS = Object.freeze({
  SCROLL_DOWN:
    'https://res.cloudinary.com/tedxnitrourkela/video/upload/assets/gif/scrollDown_gj8lj3.mp4',
  PEAK:
