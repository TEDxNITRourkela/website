...
export const LIVEGUESTS = [
  {
    ...
    image: SPEAKERS.LIVESPEAKERS.ONE,
    isLongCard: false,
    links: [
      {
      ...
      },
      {
        ...
        link_type: 'fab fa-facebook-square',
        link_name: 'facebook',
        aria_label: 'Facebook',
      },
    ],
  },
  {
    name: 'Adam Grant',
    description: [
      'Adam Grant is a professor at the Wharton School of the University of Pennsylvania, specializing in organizational psychology. Apart from being a psychologist, ​He is the #1 New York Times bestselling author of 5 books: ',
      { href: 'http://www.adamgrant.net/thinkagain', content: 'Think Again,' },
      { href: 'http://adamgrant.net/giveandtake', content: ' Give and Take, ' },
      { href: 'http://adamgrant.net/originals', content: 'Originals,' },
      { href: 'http://adamgrant.net/optionb', content: ' Option B,' },
      ' and ',
      { href: 'http://adamgrant.net/books', content: 'Power Moves.' },
    ],
    shortDescription:
    ...
    links: [
      {
        link: 'https://www.adamgrant.net/',
        link_type: 'fas fa-globe',
        link_name: 'website',
        aria_label: 'Website',
      },
      {
        link: 'https://www.youtube.com/channel/UC2yY1krHd_ESN5DD9QaSTUA',
        link_type: 'fab fa-youtube',
        link_name: 'youtube',
        aria_label: 'Youtube',
      },
      {
        link:
          'https://twitter.com/AdamMGrant?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor',
        link_type: 'fab fa-twitter-square',
        link_name: 'twitter',
        aria_label: 'Twitter',
      },
      {
        link: 'https://www.instagram.com/adamgrant/?hl=en',
        link_type: 'fab fa-instagram',
        link_name: 'instagram',
        aria_label: 'Instagram',
      },
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        link_type: 'fas fa-graduation-cap',
        link_name: 'nit-rourkela',
        aria_label: 'NIT Rourkela Profile',
      },
      {
